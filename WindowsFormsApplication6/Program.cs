...
namespace WindowsFormsApplication6
{
    ...
    public static class PaletaKolorow
    {
        ...
        public static void PrzygotujPaleteKolorow()
        {
            ...
            for (int licznik = 1; licznik < 200; licznik++)         // kolor pierwszy palety
            {
                Paleta[licznik] = Color.FromArgb(licznik, 0, 0);
            }
            for (int licznik = 200; licznik < 600; licznik++)       // kolor drugi palety
            {
                Paleta[licznik] = Color.FromArgb(200, (licznik - 400) / 3, 0);
            }
            for (int licznik = 600; licznik < 1000; licznik++)      // kolor trzeci palety
                Paleta[licznik] = Color.FromArgb(200, 150, (licznik - 700) / 3);
        }
    }
}
